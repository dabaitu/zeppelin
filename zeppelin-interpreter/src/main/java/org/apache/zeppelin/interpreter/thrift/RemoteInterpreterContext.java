...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2016-2-8")
public class RemoteInterpreterContext implements org.apache.thrift.TBase<RemoteInterpreterContext, RemoteInterpreterContext._Fields>, java.io.Serializable, Cloneable, Comparable<RemoteInterpreterContext> {
  ...
  private static final org.apache.thrift.protocol.TField EXECUTING_USER_FIELD_DESC = new org.apache.thrift.protocol.TField("executingUser", org.apache.thrift.protocol.TType.STRING, (short)8);
  ...
  public String executingUser; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    EXECUTING_USER((short)8, "executingUser");
  ...
  static {
    ...
    tmpMap.put(_Fields.RUNNERS, new org.apache.thrift.meta_data.FieldMetaData("runners", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.EXECUTING_USER, new org.apache.thrift.meta_data.FieldMetaData("executingUser", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public RemoteInterpreterContext(RemoteInterpreterContext other) {
    ...
    if (other.isSetExecutingUser()) {
      this.executingUser = other.executingUser;
    }
  }
  ...
  public RemoteInterpreterContext setExecutingUser(String executingUser) {
    this.executingUser = executingUser;
    return this;
  }

  public void unsetExecutingUser() {
    this.executingUser = null;
  }

  /** Returns true if field executingUser is set (has been assigned a value) and false otherwise */
  public boolean isSetExecutingUser() {
    return this.executingUser != null;
  }

  public void setExecutingUserIsSet(boolean value) {
    if (!value) {
      this.executingUser = null;
    }
  }
  ...
  public boolean equals(RemoteInterpreterContext that) {
    ...
    boolean this_present_executingUser = true && this.isSetExecutingUser();
    boolean that_present_executingUser = true && that.isSetExecutingUser();
    if (this_present_executingUser || that_present_executingUser) {
      if (!(this_present_executingUser && that_present_executingUser))
        return false;
      if (!this.executingUser.equals(that.executingUser))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_executingUser = true && (isSetExecutingUser());
    list.add(present_executingUser);
    if (present_executingUser)
      list.add(executingUser);
  ...
  public int compareTo(RemoteInterpreterContext other) {
    ...
    lastComparison = Boolean.valueOf(isSetExecutingUser()).compareTo(other.isSetExecutingUser());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExecutingUser()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.executingUser, other.executingUser);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("executingUser:");
    if (this.executingUser == null) {
      sb.append("null");
    } else {
      sb.append(this.executingUser);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class RemoteInterpreterContextStandardScheme extends StandardScheme<RemoteInterpreterContext> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, RemoteInterpreterContext struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 8: // EXECUTING_USER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.executingUser = iprot.readString();
              struct.setExecutingUserIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RemoteInterpreterContext struct) throws org.apache.thrift.TException {
      ...
      if (struct.executingUser != null) {
        oprot.writeFieldBegin(EXECUTING_USER_FIELD_DESC);
        oprot.writeString(struct.executingUser);
        oprot.writeFieldEnd();
      }
